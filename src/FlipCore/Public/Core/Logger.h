...
enum : uint16_t 
{
    ...
    { \
        ...
        Flip::Logger::GetInstance().Log(std::move(buffer), Flip::LogVerbosity::Error, __VA_ARGS__); \
    }
    ...
    { \
        ...
        Flip::Logger::GetInstance().Log(std::move(buffer), Flip::LogVerbosity::Warning, __VA_ARGS__); \
    }
    ...
    { \
        ...
        Flip::Logger::GetInstance().Log(std::move(buffer), Flip::LogVerbosity::Message, __VA_ARGS__); \
    }
